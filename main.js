...
function startServer(TWITCH_CLIENT_ID, TWITCH_CLIENT_SECRET, TWITCH_REDIRECT_URI) {
    ...
    server.get('/dashboard/head-transparent.webm', (req,res) => res.sendFile(path.join(__dirname,'dashboard','head-transparent.webm')));
...
server.get('/dashboard/ac-altair.png', (req,res) => res.sendFile(path.join(__dirname,'dashboard','ac-altair.png')));
server.get('/dashboard/presets.html', (req, res) => {
    ...
    server.post('/api/obs/focus', (req, res) => {
        const { exec } = require('child_process');
        const encoded = '';
        exec('powershell -NoProfile -NonInteractive -EncodedCommand ' + encoded, function() {});
        res.json({ success: true });
    });
